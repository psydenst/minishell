...
It is the first group project in the 42 core curriculum. I've done it with cadet tde-souza.
...
For everything else the subject allows only to use a few low-level functions.
...
```
git clone https://github.com/psydenst/minishell
```
```
cd minishell && make
```
